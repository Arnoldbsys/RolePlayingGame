public class —келет extends ѕерсонаж implements Iћогу¬резать,Iћогу«аорать {
    public —келет(String им€) {
        super(им€);
    }
    ...
    public boolean врезать(ѕерсонаж кому¬резать) {
        ...
        System.out.println("скелет " + this.get»м€() + " врезал игроку " + кому¬резать.get»м€()
    ...
    @Override
    public void заорать() {
        System.out.println(" Ўкл€кЎкл€кјјјбр€кјајајај”””!" );
    }
}
